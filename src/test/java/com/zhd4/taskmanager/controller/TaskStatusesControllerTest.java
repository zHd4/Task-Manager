...
public class TaskStatusesControllerTest {
    ...
    public void testDefaultStatuses() throws Exception {
        Assertions.assertThat(taskStatusRepository.findBySlug("draft")).isPresent();
        Assertions.assertThat(taskStatusRepository.findBySlug("to_review")).isPresent();
        Assertions.assertThat(taskStatusRepository.findBySlug("to_be_fixed")).isPresent();
        Assertions.assertThat(taskStatusRepository.findBySlug("to_publish")).isPresent();
        Assertions.assertThat(taskStatusRepository.findBySlug("published")).isPresent();
    }
}
